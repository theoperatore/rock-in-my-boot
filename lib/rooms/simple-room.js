...
export function generateRoom(getState) {
  let state = getState();
  ...
  return {
    ...
    actionHandlers: {
      ...
      'steal' (dispatch, getState, action) {
        dispatch({
          type: 'RESOLVE_ROOM',
          message:  'You get nothing...beause the room is empty. You actually lost some Rogue Points.',
